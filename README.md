...
> Key Features of Math Magicians Website
...
> A new developer can use this project as a guide to creating a Simple Calculator.
...
```sh
  cd my-folder
  git clone https://github.com/mohametalmeari/math-magicians.git
```
...
> The Math Magicians website will contain more animations in the future, providing a fully responsive design for optimal user experience.
...
- **How to build Math Magicians?**

  - Follow the steps in this link https://github.com/microverseinc/curriculum-react-redux/blob/main/math-magicians/sneak_peek.md
